# Règles pour ce projet (objectif : apprentissage)
- Je suis en reconversion, de niveau intermédiaire. Vulgarise les concepts.
- Explique TOUJOURS ton intention AVANT d'écrire du code.
- Pour les nouvelles parties, explique moi toujours l'architecture que l'on va construire et pourquoi avant de coder.
